...
public class SurfaceViewRenderer implements GLSurfaceView.Renderer {
	...
	public SurfaceViewRenderer(Activity fragment, GLSurfaceView view) {
		super();
		this.fragment = fragment;
		this.mGLSurfaceView = view;
		this.initializeGLSurfaceView(this.mGLSurfaceView);
		mCurrentEffect = R.id.none;
	}

	public void ApplyEffect(int currentEffect) {
	...
	private void loadTextures() {
		...
		// Load input bitmap
		Bitmap bitmap = BitmapFactory.decodeResource(fragment.getResources(),
				R.drawable.puppy);
